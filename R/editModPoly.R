...
editModPoly <- function(input, output, session, leafmap, targetLayerId = NULL, sf = TRUE, record = FALSE, crs = 4326) {
    ...
    if (is.null(Find(function(cl) {
        ...
        leafmap <- leaflet.extras::addDrawToolbar(leafmap, targetGroup = targetLayerId, polylineOptions = FALSE, polygonOptions = leaflet.extras::drawPolygonOptions(repeatMode = TRUE), 
