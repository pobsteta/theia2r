...
raster2rgb <- function(in_rast, 
  ...
  palette_builtin <- c(
    "SCL" = system.file("extdata","palettes","SCL.txt", package="theia2r"),
    "NDVI" = system.file("extdata","palettes","NDVI.cpt", package="theia2r"),
    "generic_ndsi" = system.file("extdata","palettes","NDSI.cpt", package="theia2r"),
    "Zscore" = system.file("extdata","palettes","Zscore.cpt", package="theia2r")
  )
